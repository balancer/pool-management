...
@inject('root')
@observer
class InvestFormHandler extends React.Component<any, any> {
    ...
    onSubmitJoinSwapExternAmountIn() {
        ...
        poolStore.joinswapExternAmountIn(
            poolAddress,
            inputs.inputToken,
            helpers.toWei(inputs.inputAmount)
        );
    }
    ...
    onSubmitJoinSwapPoolAmountOut() {
        ...
        poolStore.joinswapPoolAmountOut(
            poolAddress,
            inputs.inputToken,
            helpers.toWei(inputs.poolOutputAmount)
        );
    }
    ...
    onSubmitdExitSwapPoolAmountIn() {
        ...
        poolStore.exitswapPoolAmountIn(
            poolAddress,
            inputs.outputToken,
            helpers.toWei(inputs.poolInputAmount)
        );
    }
    ...
    onSubmitExitSwapExternAmountOut() {
        ...
        poolStore.exitswapExternAmountOut(
            poolAddress,
            inputs.outputToken,
            helpers.toWei(inputs.outputAmount)
        );
    }
                ...
                <Grid container spacing={1}>
                    <Grid item xs={12} sm={12}>
                        <ValidatorForm
                            ref="form"
                            onSubmit={() => {
                                this.onSubmitJoinSwapExternAmountIn();
                            }}
                            onError={errors => console.log(errors)}
                        >
                            <Grid container spacing={1}>
                ...
                <Grid container spacing={1}>
                    <Grid item xs={12} sm={12}>
                        <ValidatorForm
                            ref="form"
                            onSubmit={() => {
                                this.onSubmitJoinSwapPoolAmountOut();
                            }}
                            onError={errors => console.log(errors)}
                        >
                            <Grid container spacing={1}>
                ...
                <Grid container spacing={1}>
                    <Grid item xs={12} sm={12}>
                        <ValidatorForm
                            ref="form"
                            onSubmit={() => {
                                this.onSubmitdExitSwapPoolAmountIn();
                            }}
                            onError={errors => console.log(errors)}
                        >
                            <Grid container spacing={1}>
                ...
                <Grid container spacing={1}>
                    <Grid item xs={12} sm={12}>
                        <ValidatorForm
                            ref="form"
                            onSubmit={() => {
                                this.onSubmitExitSwapExternAmountOut();
                            }}
                            onError={errors => console.log(errors)}
                        >
                            <Grid container spacing={1}>
                                ...
                                <Grid item xs={12} sm={3}>
                                    <TextValidator
                                        ...
                                        name="outputAmount"
                                        label={
                                            labels.inputs.TOKEN_OUTPUT_AMOUNT
                                        }
