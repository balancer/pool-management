...
class InvestForm extends React.Component {
    ...
    render() {
        ...
        const methods = [
            ...
            { label: labels.methods.JOINSWAP_EXTERN_AMOUNT_IN, name: methodNames.JOINSWAP_EXTERN_AMOUNT_IN },
            { label: labels.methods.JOINSWAP_POOL_AMOUNT_OUT, name: methodNames.JOINSWAP_POOL_AMOUNT_OUT },
            { label: labels.methods.EXIT_POOL, name: methodNames.EXIT_POOL },
            { label: labels.methods.EXITSWAP_POOL_AMOUNT_IN, name: methodNames.EXITSWAP_POOL_AMOUNT_IN },
            { label: labels.methods.EXITSWAP_EXTERN_AMOUNT_OUT, name: methodNames.EXITSWAP_EXTERN_AMOUNT_OUT }
        ]
        ...
        return (
            <Grid container style={{ marginBottom: '50px' }}>
                <FormControl className={classes.formControl}>
                    <InputLabel htmlFor="demo-controlled-open-select">Invest method</InputLabel>
                    <Select
                        open={open}
