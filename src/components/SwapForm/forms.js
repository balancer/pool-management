...
import { swapExactAmountIn, swapExactAmountOut, swapExactMarginalPrice, updatePriceExactAmountIn, updatePriceExactAmountOut, updatePriceExactMarginalPrice } from './calls'
...
async function updatePrice() {
  // const { method, provider, address } = props
